...
CREATE TABLE IF NOT EXISTS `s08p11d109`.`user_info` (
  ...
  `profile_public` TINYINT NOT NULL DEFAULT 1,
...
insert into user values(1, 'admin', '1234', 'token', 1);
insert into user_info values(1, '어드민', '닉네임어드민', '010-1234-5678', 'asd@qwer.com', 'photo', 1, 1);
commit; 
