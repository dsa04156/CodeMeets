...
CREATE TABLE `alarm` (
  ...
  UNIQUE KEY `alarm_pk_UNIQUE` (`alarm_pk`),
  KEY `alarm.alarm_to_id_idx` (`alarm_to_id`),
  CONSTRAINT `alarm.alarm_to_id` FOREIGN KEY (`alarm_to_id`) REFERENCES `user` (`user_pk`) ON DELETE CASCADE
